# Stacked (generator-stacked)
[cl0udc0ntr0l.github.io/generator-stacked](http://cl0udc0ntr0l.github.io/generator-stacked)
...
## The Workflow
![](http://cl0udc0ntr0l.github.io/generator-stacked/img/toolset.png)
Our workflow is comprised of three tools for improving your productivity and satisfaction when building a web app: yo (the scaffolding tool), grunt (the build tool), npm (for sever side package management), bower (for client side package management).
