...
define(["jquery", "backbone", "text!templates/<%= initName %>.html", "views/<%= initName %>View", "models/<%= initName %>Model", "collections/<%= initName %>Collection", "routers/Router", "jasmine-jquery"],
